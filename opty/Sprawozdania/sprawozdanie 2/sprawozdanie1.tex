...
\include{quickSort}                % omit the '.tex' extension
\include{mergeSort}                % omit the '.tex' extension
\include{heapSort}                % omit the '.tex' extension
\include{shellSort}                % omit the '.tex' extension
\include{bitonicSort}                % omit the '.tex' extension
\include{autorski}                % omit the '.tex' extension
...
\bibitem{heapsort}\url{http://ind.ntou.edu.tw/~litsnow/al98/pdf/Algorithm-Ch6-Heapsort.pdf}
\bibitem{bitonic}\url{http://research.ijcaonline.org/volume113/number13/pxc3901930.pdf}
\bibitem{shell}\url{http://www.cs.wcupa.edu/rkline/ds/shell-comparison.html}
\bibitem{shellCiura}\url{http://sun.aei.polsl.pl/~mciura/publikacje/shellsort.pdf}
\end{thebibliography}
\end{document}
